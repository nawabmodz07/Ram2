...
TOKEN = '7588159887:AAFrDDQk5H2hkXyGmrZxIVWp3LV7rILfrQQ'  # Replace with your actual bot token
ADMIN_IDS = [5898718899]  # Added new admin ID
CHANNEL_ID = 'pest id'  # Replace with your specific channel or group ID
# Initialize the bot
...
def reset_attack_limit(message):
    owner_id = yha pest kro id  # Replace with the actual owner ID
...
FEEDBACK_CHANNEL_ID = "id pest kro"  # Replace with your actual feedback channel ID
